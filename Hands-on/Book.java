...
public class Book 
{
	...
	//Constructor for title, author, and isbn as parameters and sets the year to the current yea
	...
	public static void main(String[] args) 
	{
		...
		System.out.println("title is: "+Book3.getTitle() + " Authoris :" + Book3.getAuthor() + "isbn is :" + Book3.getIsbn() + "Year is: " + Book3.getYear());
